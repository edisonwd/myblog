...
| ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| ![](../image/使用PyMuPDF4LLM解析PDF的图片和表格/ef61dfb4.png) | ![](../image/使用PyMuPDF4LLM解析PDF的图片和表格/b9fdcaa9.png) |
...
| --------------------------------------------------------------------------------------------------- | ------------------------- |
|      ![](../image/使用PyMuPDF4LLM解析PDF的图片和表格/511f97f6.png)                                                                                               |           ![](../image/使用PyMuPDF4LLM解析PDF的图片和表格/76651d12.png)                |
